...
#
# TSTEP      Time step optional  TSTEP_LINEAR,TSTEP_QUADRATIC,TSTEP_CUBIC : overrules TSTEP
# NLON       Number of points (x)
# NLAT       Number of points (y)
# NLON_MINIM Number of points (x) for larger extension zone (minimization only)
# NLAT_MINIM Number of points (y) for larger extension zone (minimization only)
...
#      'TSTEP_CUBIC'  => '120',
  ...
  'IGA'=>{
   ...
   'EUR11'=>{   # Domain used for HCLIM43-ALADIN contributions to Euro-CORDEX in CORDEX6
      'TSTEP'  => '450',
      'NLON'   => '480',
      'NLAT'   => '480',
      'LONC'   => '10.5',
   ...
   'AFR22' =>{
      'TSTEP'  => '450',                               # Time step
      'NLON'   => '432',                               # Number of points (x)
      'NLAT'   => '540',                                # Number of points (y)
      'LONC'   => '18.0',                              # Longitude of domain centre (degrees)
      'LATC'   => '0.0',                                  # Latitude of domain center (degrees)
      'LON0'   => '18.0',                              # Reference longitude of the projection (degrees)
      'LAT0'   => '0.0',                                  # Reference latitude of the projection (degrees)
      'GSIZE'  => '25000.',                          # Grid size in meters (x,y)
   },
   'ANT11'=>{   # Domain used for HCLIM43-ALADIN contributions to Antarctic CORDEX in CORDEX6
      'TSTEP'  => '450',                             # Time step
      'NLON'   => '750',                             # Number of points (x)
      'NLAT'   => '648',                             # Number of points (y)
      'LONC'   => '-20.0',                           # Longitude of domain centre (degrees)
      'LATC'   => '-85.00',                          # Latitude of domain center (degrees)
      'LON0'   => '20.0',                            # Reference longitude of the projection (degrees)
      'LAT0'   => '-90.0',                           # Reference latitude of the projection (degrees)
      'GSIZE'  => '11000.',                          # Grid size in meters (x,y)
   },
   'ARC11'=>{   # Domain used for HCLIM43-ALADIN contributions to Arctic CORDEX in CORDEX6
      'TSTEP'  => '450',                             # Time step
      'NLON'   => '640',                             # Number of points (x)
      'NLAT'   => '720',                             # Number of points (y)
      'LONC'   => '150.0',                           # Longitude of domain centre (degrees)
      'LATC'   => '88.0',                            # Latitude of domain center (degrees)
      'LON0'   => '0.0',                             # Reference longitude of the projection (degrees)
      'LAT0'   => '90.0',                            # Reference latitude of the projection (degrees)
      'GSIZE'  => '11000.',                          # Grid cell size (meters)
   },
  );
  ...
  if ( ! defined($domains{$domain}{'EZONE'}) ){
    unless ( $domains{$domain}{'EZONE'} ) { $domains{$domain}{'EZONE'}=$default_ezone; }
  }
  # IZONE if not given by user
  if ( ! defined($domains{$domain}{'IZONE'}) ){
    unless ( $domains{$domain}{'IZONE'} ) { $domains{$domain}{'IZONE'}=$default_izone; }
  }
  ...
  # NLON_MINIM if not given by user
  unless ( $domains{$domain}{'NLON_MINIM'} ) { $domains{$domain}{'NLON_MINIM'}=0; }
  # NLAT_MINIM if not given by user
  unless ( $domains{$domain}{'NLAT_MINIM'} ) { $domains{$domain}{'NLAT_MINIM'}=0; }
  ...
  $domains{$domain}{'TRUNC'} = $grid_type{$ENV{GRID_TYPE}}{'trunc'};
